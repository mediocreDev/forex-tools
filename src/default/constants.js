...
// TradingView chart symbols for each pair (keyed by pair value, uppercased)
// Format: "EXCHANGE:SYMBOL" — edit these to change which chart opens
export const TRADINGVIEW_SYMBOLS = {
  ...
  EURCHF:  "FOREXCOM:EURCHF",
  EURAUD:  "FOREXCOM:EURAUD",
  EURCAD:  "FOREXCOM:EURCAD",
  EURNZD:  "FOREXCOM:EURNZD",
  GBPAUD:  "FOREXCOM:GBPAUD",
  GBPCAD:  "FOREXCOM:GBPCAD",
  GBPCHF:  "FOREXCOM:GBPCHF",
  GBPNZD:  "FOREXCOM:GBPNZD",
  AUDJPY:  "FOREXCOM:AUDJPY",
  AUDNZD:  "FOREXCOM:AUDNZD",
  AUDCAD:  "FOREXCOM:AUDCAD",
  AUDCHF:  "FOREXCOM:AUDCHF",
  NZDJPY:  "FOREXCOM:NZDJPY",
  NZDCHF:  "FOREXCOM:NZDCHF",
  NZDCAD:  "FOREXCOM:NZDCAD",
  CADJPY:  "FOREXCOM:CADJPY",
  CADCHF:  "FOREXCOM:CADCHF",
  CHFJPY:  "FOREXCOM:CHFJPY",
  XAUUSD:  "FOREXCOM:XAUUSD",
  USOIL:   "FOREXCOM:USOILUSD",
